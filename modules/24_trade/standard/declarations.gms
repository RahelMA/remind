...
p24_XportPermCum(tall,all_regi)             "Cumulated export of permits"
p24_MportPermCum(tall,all_regi)             "Cumulated import of permits"
p24_NetPermCum(tall,all_regi)               "Cumulated net trade of permits"
;
***-------------------------------------------------------------------------------
***                                   VARIABLES
***-------------------------------------------------------------------------------
