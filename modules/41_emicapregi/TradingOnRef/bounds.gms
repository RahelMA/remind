...
vm_Xport.up(t,regi,"perm")$(t.val le 2100)=abs(20/100*(p41_co2eq(t,regi)));
vm_Xport.up(t,regi,"perm")$(t.val gt 2100)=0;
vm_Mport.up(t,regi,"perm")$(t.val le 2100)=abs(20/100*(p41_co2eq(t,regi)));
vm_Mport.up(t,regi,"perm")$(t.val gt 2100)=0;
);
