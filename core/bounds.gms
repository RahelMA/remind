...
if(c_ccsinjecratescen = 0,
  vm_co2CCS.fx(t,regi_capturescen,teccsinje(te)) = 0;
);
...
*' 12 Gt storage potential in Germany, 50-75 Mt/a injection => 60 Mt/a => 60/12000=0.005
  vm_co2CCS.up(t,regi,te)$(teccsinje(te)) = pm_dataccs(regi,"quan",te)$(teccsinje(te)) * pm_ccsinjecrate(regi);
...
*** Norway and UK announced to store CO2 for EU27 countries. So 50% of Norway and UK potential in 2030 is attributed to EU27-Pool
  if(not cm_emiscen = 1, !! cm_emiscen 1 = BAU
    vm_co2CCS.lo(t,regi,"ccsinjeon") $ (t.val <= 2030) = s_MtCO2_2_GtC * p_boundCapCCS(t,regi,"operational") $ (t.val <= 2030);
    vm_co2CCS.up(t,regi,"ccsinjeon") $ (t.val <= 2030) = s_MtCO2_2_GtC * (
