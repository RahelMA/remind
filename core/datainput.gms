...
*** Years greater equal cm_startyear get their values below from the lookup table (f_macBaseMagpie).
...
*** Overwrie values >= startyear with lookup table, leave values < startyear untouched (from input_ref.gdx, see above)
