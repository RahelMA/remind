...
pm_actualbudgetco2Regi(ttot,regi)$( 2020 lt ttot.val )
  ...
  * sm_c_2_co2;
!! until 10.09. this was the default implementation for pm_actualbudgetco2Regi, leading to EOC ~200Gt below intended
pm_actualbudgetco2Regi_noLULUCF(ttot,regi)$(2020 lt ttot.val) = 
    sum((ttot2)$(2020 le ttot2.val AND ttot2.val le ttot.val),       
        (vm_emiAll.l(ttot2,regi,"co2") -
...
p_actualbudgetco2_iterRegi(iteration,ttot,regi)$( 2020 lt ttot.val) = pm_actualbudgetco2Regi(ttot,regi);
