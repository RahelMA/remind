...
*' cm_LTSstartYr                       choose when rescaling of net-zero targets starts
*' *  (2040):                          default start of rescaling is 2040 (first meet 2035 NDC targets, scenario knows as NDC-LTS)
*' *  (2035):                          it can also be set to 2035 to directly reach net-zero, scenario known as LTS 
